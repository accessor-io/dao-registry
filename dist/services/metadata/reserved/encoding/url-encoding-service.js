...
exports.SubdomainEncodingService = exports.URLEncodingService = exports.URL_ENCODING_PATTERNS = void 0;
/**
 * URL encoding regex patterns for subdomain validation
 */
exports.URL_ENCODING_PATTERNS = {
...
class URLEncodingService {
     ...
     */
    static encodeDNS(str) {
        return str
            .toLowerCase()
            .replace(exports.URL_ENCODING_PATTERNS.DNS_ENCODE_CHARS, '')
            .replace(exports.URL_ENCODING_PATTERNS.MULTIPLE_HYPHENS, '-')
            .replace(exports.URL_ENCODING_PATTERNS.LEADING_TRAILING_HYPHENS, '');
    }
    /**
     * Encode string for ENS usage
     */
    static encodeENS(str) {
        return str
            .toLowerCase()
            .replace(exports.URL_ENCODING_PATTERNS.ENS_ENCODE_CHARS, '')
            .replace(exports.URL_ENCODING_PATTERNS.MULTIPLE_HYPHENS, '-')
            .replace(exports.URL_ENCODING_PATTERNS.LEADING_TRAILING_HYPHENS, '');
    }
    /**
    ...
    static sanitizeSubdomain(subdomain) {
        return subdomain
            .toLowerCase()
            .trim()
            .replace(exports.URL_ENCODING_PATTERNS.WHITESPACE_CHARS, '-')
            .replace(exports.URL_ENCODING_PATTERNS.CONTROL_CHARS, '')
            .replace(exports.URL_ENCODING_PATTERNS.UNICODE_CHARS, '')
            .replace(exports.URL_ENCODING_PATTERNS.DNS_ENCODE_CHARS, '')
            .replace(exports.URL_ENCODING_PATTERNS.MULTIPLE_HYPHENS, '-')
            .replace(exports.URL_ENCODING_PATTERNS.LEADING_TRAILING_HYPHENS, '');
    }
    ...
    static validateSubdomainFormat(subdomain) {
        ...
        // Check length
        if (sanitized.length < exports.URL_ENCODING_PATTERNS.SUBDOMAIN_LENGTH.MIN) {
            errors.push(`Subdomain must be at least ${exports.URL_ENCODING_PATTERNS.SUBDOMAIN_LENGTH.MIN} character long`);
        }
        if (sanitized.length > exports.URL_ENCODING_PATTERNS.SUBDOMAIN_LENGTH.MAX) {
            errors.push(`Subdomain cannot exceed ${exports.URL_ENCODING_PATTERNS.SUBDOMAIN_LENGTH.MAX} characters`);
        }
        // Check for invalid patterns
        for (const pattern of exports.URL_ENCODING_PATTERNS.INVALID_DOMAIN_PATTERNS) {
            if (pattern.test(sanitized)) {
                errors.push(`Subdomain contains invalid pattern: ${pattern.source}`);
            }
        }
        // Check character set
        if (!exports.URL_ENCODING_PATTERNS.DNS_SAFE_CHARS.test(sanitized)) {
    ...
    static validateDomainFormat(domain) {
        ...
        // Check length
        if (sanitized.length < exports.URL_ENCODING_PATTERNS.DOMAIN_LENGTH.MIN) {
            errors.push(`Domain must be at least ${exports.URL_ENCODING_PATTERNS.DOMAIN_LENGTH.MIN} character long`);
        }
        if (sanitized.length > exports.URL_ENCODING_PATTERNS.DOMAIN_LENGTH.MAX) {
            errors.push(`Domain cannot exceed ${exports.URL_ENCODING_PATTERNS.DOMAIN_LENGTH.MAX} characters`);
        }
        // Check for dots
    ...
    static hasUnicode(str) {
        return exports.URL_ENCODING_PATTERNS.UNICODE_CHARS.test(str);
    }
    /**
     * Check if string is punycode encoded
     */
    static isPunycode(str) {
        return exports.URL_ENCODING_PATTERNS.PUNYCODE_PATTERN.test(str);
    }
    /**
     ...
     */
    static createSubdomainPattern(subdomain) {
     ...
     */
    static createDomainPattern(domain) {
     ...
     */
    static buildDomain(subdomain, tld) {
     ...
     * Validate TLD format
     */
    static validateTLD(tld) {
        const errors = [];
        const sanitized = tld.toLowerCase().trim();
        if (!exports.URL_ENCODING_PATTERNS.VALID_TLD_PATTERN.test(sanitized)) {
...
exports.URLEncodingService = URLEncodingService;
/**
 * Subdomain encoding utilities
 */
class SubdomainEncodingService {
    /**
     * Validate and encode subdomain for DNS usage
     */
    static encodeForDNS(subdomain) {
     ...
     */
    static generateVariations(input) {
     ...
     */
    static isAvailable(subdomain, reservedList) {
     ...
     */
    static findAvailableSubdomain(input, reservedList) {
...
exports.SubdomainEncodingService = SubdomainEncodingService;
//# sourceMappingURL=url-encoding-service.js.map